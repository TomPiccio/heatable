...
class FakeEconomy extends StatefulWidget {
  final int row_num;

  const FakeEconomy({super.key, required this.row_num});

  @override
  State<FakeEconomy> createState() => _FakeEconomyState();
}

class _FakeEconomyState extends State<FakeEconomy> {
  String row_num2 = "01";
  @override
  void initState() {
    super.initState();
